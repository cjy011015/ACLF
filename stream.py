...
feature_names = [
    ...
    'HDL-C', 'Cr', 'INR', 'Globulin', 'Neutrophils'
]
...
# 数值型特征（含肌酐单位选择）
# =========================
numeric_features = ['HDL-C', 'Cr', 'INR', 'Globulin', 'Neutrophils']
default_values = {'HDL-C': 1.2, 'Cr': 70.0, 'INR': 1.1, 'Globulin': 30.0, 'Neutrophils': 4.0}
